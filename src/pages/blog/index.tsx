              ...
              <div className="overflow-hidden rounded-xl bg-white shadow-lg">
                ...
                <div className="rounded-bl-3xl rounded-br-3xl bg-white px-10 py-6">
                  ...
                  <p className="mt-6 w-11/12 text-base  tracking-wide text-gray-700 lg:text-lg lg:leading-8">
                    ...
                    redefining the way we interact with the world wide web. It&apos;s
                    the silent engine powering a new era of user experience,
                    driving personalized content, and streamlining processes in
                    a way that once seemed the stuff of science fiction. As we
                    stand on the cusp of this technological renaissance, AI
