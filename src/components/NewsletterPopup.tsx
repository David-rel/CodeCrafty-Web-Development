...
export default function NewsletterPopup({
  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 top-1/2 z-50 min-w-full -translate-x-1/2 -translate-y-1/2 transform p-4">
        <div
          className={`mx-auto max-w-2xl rounded-lg bg-white p-8 shadow-lg transition-all duration-500 sm:p-4 ${
            isVisible ? "animate-slideInFromBottom" : ""
          }`}
        >
          <div className="relative w-full rounded pb-4 pt-6 sm:pb-8 sm:pt-10">
            <div className="flex flex-col items-center">
              ...
              <Image
                ...
                height={400}
              />
              <p className="mt-4 text-center text-base font-bold text-rose-700 sm:text-lg md:text-2xl md:leading-6">
              ...
              <div className="mt-4 flex w-full flex-col items-center sm:mt-6 sm:flex-row">
                <div className="mb-2 w-full rounded border border-gray-200 bg-gray-50 sm:mb-0">
                  <input
                ...
                <button
                  className="send-button ml-0 mt-2 flex w-full items-center justify-center rounded bg-rose-700 px-3 py-3 hover:bg-opacity-80 focus:outline-none dark:bg-rose-600 sm:ml-2 sm:mt-0 sm:w-auto"
                  type="button"
              ...
              {state === "ERROR" && (
                <p className="mt-2 w-full text-center text-red-600">
                  {errorMessage}
                </p>
              )}
              {state === "SUCCESS" && (
                <p className="mt-2 w-full text-center text-green-600">
                  Success!
                </p>
              )}
            </div>
